...
import { Sparkles, Gamepad2, Globe, Palette, User, Users, Smartphone, Laptop, CheckCircle } from 'lucide-react';
...
// Extracted StepContent component to prevent re-creation on every render
interface StepContentProps {
  ...
  toggleArrayItem: (key: 'goals' | 'devices', value: string) => void;
